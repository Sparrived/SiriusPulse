...
5. `sirius_pulse/__init__.py`（顶层公开 API 清单）
6. `sirius_pulse/persona_manager.py`
7. `sirius_pulse/persona_worker.py`
8. `sirius_pulse/platforms/runtime.py`
9. `sirius_pulse/core/emotional_engine.py`
