...
- **修改 WebUI**：同步检查 `sirius_pulse/webui/server.py`、`webui/server_core.py`、`webui/persona_api.py`、`webui/memory_api.py`、`webui/napcat_api.py`、`webui/server_skill_api.py`。
