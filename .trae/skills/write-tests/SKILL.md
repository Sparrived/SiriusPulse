...
> 新测试应针对 `EmotionalGroupChatEngine` 及其子系统（`BasicMemoryManager`、`DiaryManager`、`SemanticMemoryManager`、`ContextAssembler`、`UserManager` 等）编写。
...
| `token/store.py` | `tests/test_token_store.py` |
| `config/manager.py` | `tests/test_config_manager.py` |
| `models/models.py` | `tests/test_public_api.py` |
| `session/store.py` | `tests/test_api_integrity.py` |
| `persona_manager.py` | `tests/test_persona_integration.py` |
| `persona_worker.py` | `tests/test_persona_integration.py` |
| `identity_resolver.py` | `tests/test_identity_resolver.py` |
| `logging_config.py` | `tests/test_logging_config.py` |
