...
_TRIPLE_EXTRACTION_PROMPT = (
    ...
    "{{\n"
    '  "triples": [\n'
    '    {{"subject": "小明", "predicate": "搬到",'
    ' "obj": "深圳", "confidence": 0.95,'
    ' "meta_tag": "stated"}},\n'
    '    {{"subject": "小明", "predicate": "退了",'
    ' "obj": "北京的房子", "confidence": 0.95,'
    ' "meta_tag": "stated"}},\n'
    '    {{"subject": "小明",'
    ' "predicate": "搬家时间", "obj": "上周",'
    ' "confidence": 0.9, "meta_tag": "stated"}}\n'
    "  ],\n"
