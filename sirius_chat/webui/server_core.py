...
class WebUIServer:
    ...
    if TYPE_CHECKING:
        ...
        async def api_persona_biography_update(self, request: web.Request) -> web.Response: ...
    ...
    def _setup_routes(self) -> None:
        ...
        self.app.router.add_post("/api/personas/{name}/biography/{user_id}", self.api_persona_biography_update)
